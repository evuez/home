...
INSTALLATION_DIR="/opt/sublime-text"
...
sudo ln -s $INSTALLATION_DIR/sublime_text.desktop /usr/share/applications/sublime-text.desktop

# Set the icon (thanks gcaracuel)
sudo sed -i.bak 's/Icon=sublime-text/Icon=\/opt\/sublime-text\/Icon\/128x128\/sublime-text.png/g' /usr/share/applications/sublime-text.desktop
