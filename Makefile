...
install:
	...
	hash httpie 2>/dev/null || sudo dnf install httpie
...
prepare:
	...
	[[ -d "`eval echo '~/.vim/bundle/Vundle.vim'`" ]] || git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim
